...
_SPECS: tuple[tuple[str, KernelBackend, str, frozenset, str], ...] = (
    ...
    (
        "diffusion.lora_scale_add",
        KernelBackend.TRITON,
        "modulate.lora_scale_add:fused_lora_scale_add_",
        _CUDA,
        "Bit-exact in-place BF16 dynamic-LoRA scale and residual add.",
    ),
    (
        "diffusion.stacked_lora_bmm",
        KernelBackend.TORCH,
        "modulate.lora_scale_add:direct_stacked_lora_bmm",
        _CUDA,
        "Bit-exact grouped LoRA B GEMM with direct token-major output.",
    ),
    (
        "diffusion.contracted_lora_addmm",
        KernelBackend.TORCH,
        "modulate.lora_scale_add:contracted_lora_addmm_",
        _CUDA,
        "Opt-in contracted BF16 LoRA B GEMM and residual epilogue.",
    ),
    (
        "diffusion.contracted_stacked_lora_baddbmm",
        KernelBackend.TORCH,
        "modulate.lora_scale_add:contracted_stacked_lora_baddbmm_",
        _CUDA,
        "Opt-in contracted stacked BF16 LoRA B GEMM and residual epilogue.",
    ),
    (
...
_EXPORTS: dict[str, str] = {
    ...
    "try_mul_reduce_max_f32_exact": "norm.minimax_h3_vae",
    "try_restore_scale_add_bias_f32_exact": "norm.minimax_h3_vae",
    "try_scale_cast_f16_exact": "norm.minimax_h3_vae",
    ...
    "can_use_contracted_lora_addmm": "modulate.lora_scale_add",
    "can_use_contracted_stacked_lora_baddbmm": "modulate.lora_scale_add",
    "can_use_direct_stacked_lora_bmm": "modulate.lora_scale_add",
    "can_use_fused_lora_scale_add": "modulate.lora_scale_add",
    "contracted_lora_addmm_": "modulate.lora_scale_add",
    "contracted_stacked_lora_baddbmm_": "modulate.lora_scale_add",
    "direct_stacked_lora_bmm": "modulate.lora_scale_add",
    "fused_lora_scale_add_": "modulate.lora_scale_add",
