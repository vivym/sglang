...
def _supports_direct_gpu_weight_loading(
    ...
    return bool(
        quant_name in ("int8", "kitchen_int8")
...
class TransformerLoader(OnlineQuantizationComponentLoader):
    ...
    def load_customized(
        ...
        legacy_adaln_path = os.environ.get("MINIMAX_H3_ADALN_TABLE_PATH")
        if is_minimax_h3 and adaln_cache_path is None and legacy_adaln_path:
            logger.warning(
                "MINIMAX_H3_ADALN_TABLE_PATH is deprecated; use "
                "--minimax-h3-adaln-cache-path"
            )
            adaln_cache_path = legacy_adaln_path
        if adaln_cache_path is not None:
            ...
            init_params["adaln_cache_provenance"] = getattr(
                quant_spec.runtime_quant_config,
        ...
        checkpoint_load_device = (
            ...
            if cpu_offload_flag
                ...
                quantized_cpu_load_supported=(
                    ...
                    or quant_spec.is_serialized_legacy_int8
