...
class MiniMaxH3DecodingStage(DecodingStage):
    ...
    def _warmup_audio_vae_decode(
        ...
        # Prime BigVGAN's lazy CUDA kernels without decoding a full user clip.
    ...
    def _decode_audio(
        ...
        *,
        ...
        with self.use_declared_component(
            ...
            with _deterministic_audio_decode_context(), audio_autocast_context:
