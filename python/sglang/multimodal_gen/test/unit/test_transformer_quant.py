...
class TestTransformerQuantHelpers(unittest.TestCase):
    ...
    def test_direct_gpu_loading_accepts_only_serialized_int8_quantization(self):
        ...
        serialized_kitchen_int8 = TransformerQuantLoadSpec(
            [],
            _make_quant_config("kitchen_int8", is_checkpoint_int8_serialized=True),
            None,
            None,
        )
        ...
        self.assertTrue(_supports_direct_gpu_weight_loading(serialized_kitchen_int8))
